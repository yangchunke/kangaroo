...
public class ThriftDbClient extends DbService.Client implements AutoCloseable {
  ...
  public static ThriftDbClient getClient(String host, int port)
      throws SocketException, TTransportException {
    return getClient(host, port, DEF_SOCKET_TIMEOUT, DEF_CONNECT_TIMEOUT);
  }

  public static ThriftDbClient getClient(String host, int port, int socketTimeout,
      int connectTimeout) throws SocketException, TTransportException {
